...
const CompanionComponent = ({ companionId, subject, topic, name, userName, userImage, style, voice }: CompanionComponentProps) => {
    ...
    const TypingIndicator = () => (
        <div className="flex items-center space-x-1 p-3">
            ...
            <span className="text-xs text-gray-500 ml-2">{name.split(' ')[0]} is thinking...</span>
        </div>
    );
        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100 p-4">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 text-lg">Interactive voice-powered learning experience</p>
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-8 mb-8">
                    ...
                    <div className="bg-white/70 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/20">
                        <div className="flex flex-col items-center">
                            ...
                            <div className="relative mb-6">
                                ...
                                >
                                    ...
                                    <div className={cn(
                                        ...
                                        <Image src={`/icons/${subject}.svg`} alt={subject} width={120} height={120} className="drop-shadow-lg" />
                                    </div>
                                ...
                                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
                                    <div className={cn(
                                        ...
                                        callStatus === CallStatus.ACTIVE && "bg-green-500 text-white animate-pulse",
                                        callStatus === CallStatus.CONNECTING && "bg-yellow-500 text-white animate-bounce",
                                        callStatus === CallStatus.INACTIVE && "bg-gray-400 text-white",
                                        callStatus === CallStatus.FINISHED && "bg-red-500 text-white"
                                    )}>
                            ...
                            <p className="text-gray-600 text-center mb-4">Your AI {subject} tutor</p>
                            
                            {/* Subject Badge */}
                            <div className="px-6 py-2 rounded-full text-sm font-semibold text-white mb-6" style={{backgroundColor: getSubjectColor(subject)}}>
                                📚 {subject.toUpperCase()}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white/70 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/20">
                        <div className="flex flex-col items-center">
                            ...
                            <h2 className="text-3xl font-bold text-gray-800 mb-6">{userName}</h2>
                            ...
                            <div className="w-full max-w-sm space-y-4">
                                ...
                                <button 
                                    className={cn(
                                        ...
                                        callStatus !== CallStatus.ACTIVE && "opacity-50 cursor-not-allowed hover:scale-100"
                                    )}
                                    onClick={toggleMicrophone} 
                                    disabled={callStatus !== CallStatus.ACTIVE}
                                >
                                    <div className={cn("transition-transform duration-200", isSpeaking && "animate-pulse scale-110")}>
                                        <Image 
                    ...
                    <div className="h-96 overflow-y-auto p-6 space-y-4" style={{scrollbarWidth: 'thin'}}>
                        {messages.length === 0 && callStatus === CallStatus.ACTIVE && (
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-500 text-lg font-medium">Ready to start learning!</p>
                                <p className="text-gray-400 text-sm mt-2">Your conversation will appear here...</p>
                            </div>
                        )}
                        ...
                        {messages.length === 0 && callStatus !== CallStatus.ACTIVE && (
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-400 text-lg font-medium">Start a session to begin chatting</p>
                            </div>
                        )}
                        ...
                        <div className="space-y-4">
                            {messages.slice().reverse().map((message, index) => {
                                if(message.role === 'assistant') {
                                    return (
                                        <div key={index} className="flex items-start gap-3 animate-slideInLeft">
                                            <div className="w-10 h-10 rounded-full flex items-center justify-center text-white text-sm font-bold shadow-lg" style={{backgroundColor: getSubjectColor(subject)}}>
                                                🤖
                                            </div>
                                    ...
                                    return (
                                        <div key={index} className="flex items-start gap-3 flex-row-reverse animate-slideInRight">
                                            <div className="w-10 h-10 rounded-full overflow-hidden shadow-lg">
                                                <Image src={userImage} alt={userName} width={40} height={40} className="w-full h-full object-cover" />
                                            </div>
                                            <div className="flex-1 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl rounded-tr-sm p-4 shadow-md border border-green-100">
                                                <div className="flex items-center gap-2 mb-1 justify-end">
                                                    ...
                                                    <span className="font-bold text-green-800 text-sm">{userName}</span>
                                                </div>
